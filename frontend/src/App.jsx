      ...
      <div className="max-w-2xl mx-auto">
            ...
            <div className="w-8 h-8 rounded-lg bg-violet-600 flex items-center justify-center">
              ...
              >
                <path
                  ...
                  d="M17 20h5v-2a4 4 0 00-5-3.5M9 20H4v-2a4 4 0 015-3.5m0 0a4 4 0 118 0m-8 0V14m8 3.5V14m0 0a4 4 0 10-8 0"
                />
              </svg>
            </div>
        ...
        <div className="bg-slate-900 border border-slate-700 rounded-2xl p-5 mb-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <input
              onKeyDown={(e) =>
                e.key === "Enter" && (editUser ? updateUser() : addUser())
              }
          ...
          {loading ? (
            ...
            <div className="text-center py-16 bg-slate-900 border border-slate-800 rounded-2xl">
              ...
              <p className="text-slate-600 text-xs mt-1">
                উপরে নাম আর ইমেইল দিয়ে নতুন user যোগ করো
              </p>
            </div>
          ) : (
            filtered.map((user) => (
              ...
              >
                <div
                  className={`w-10 h-10 rounded-full ${getColor(user.name)} flex items-center justify-center text-white text-xs font-bold flex-shrink-0`}
                >
                    ...
                    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50">
                      <div className="bg-slate-900 border border-slate-700 rounded-2xl p-6 w-full max-w-sm mx-4">
                        ...
                        <p className="text-slate-400 text-sm mb-6">
                          এই user কে delete করলে আর ফিরিয়ে আনা যাবে না।
                        </p>
